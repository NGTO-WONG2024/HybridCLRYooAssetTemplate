    ...
    public class AllIn1SpringToolkitDemoController : MonoBehaviour
    {
        ...
        private IEnumerator Start()
        {
            ...
            if(!skipAssetHeaderIntro)
            {
                ...
                titleTransformSpring.SetValuesScaleSpring(Vector3.zero);
                titleTransformSpring.SetValuesRotationSpring(new Vector3(0f, 0f, -150f));
                yield return new WaitForSeconds(0.3f);
                splotchTransformSpring.gameObject.SetActive(true);
                splotchTransformSpring.SetValuesScaleSpring(Vector3.zero);
                yield return new WaitForSeconds(timeToWaitBeforeShowingPressToPlay);
                pressToPlayGameObject.SetActive(true);
                pressToPlayTransformSpring.SetValuesScaleSpring(new Vector3(0f, 1f, 1f));
                pressToPlayTransformSpring.SetScaleTarget(Vector3.one);
                yield return new WaitUntil(IsAnyKeyOrMouseButtonPressed);
                splotchTransformSpring.SetScaleTarget(Vector3.zero);
                yield return new WaitForSeconds(0.05f);
                titleTransformSpring.SetScaleTarget(Vector3.zero);
                yield return new WaitForSeconds(0.15f);
                pressToPlayTransformSpring.SetScaleTarget(Vector3.zero);
            ...
            infoPanelAnchoredPositionSpring.SetTargetAndReachEquilibrium(initialInfoPanelAnchoredPosition - new Vector2(0f, demoElementsParent.rect.height / 2f));
        ...
        private void ActivateIndexToTest()
        {
            ...
            if(is3dUiElement)
            {
                ...
                if(demoElementTransformSpring != null)
                {
                    ...
                    demoElementTransformSpring.SetValuesPositionSpring(demoElementGoPosition);
                }
        ...
        private IEnumerator UiDemoElementOutAnimationCoroutine(GameObject demoElementUiGo)
        {
            ...
            while (anchoredPositionSpring.anchoredPositionSpring.GetVelocity().magnitude > 0.5f)
            {
                yield return null;
            }
        ...
        private IEnumerator DemoElementOutAnimationCoroutine(GameObject demoElementUiGo)
        {
            ...
            if(demoElementTransformSpring != null)
            {
                ...
                demoElementTransformSpring.SetPositionTarget(demoElementGoPosition);
            }

            yield return new WaitForSeconds(0.1f);
            while (demoElementTransformSpring.positionSpring.GetVelocity().magnitude > 0.5f)
            {
                yield return null;
            }
        ...
        private void SetHeaderTextAndPunchScale()
        {
            ...
            {
                headerLabelTransformSpring.AddVelocityToScaleSpring(Vector3.one * headerScalePunch);
            }
        }
        ...
        private void SetInfoPanelText()
        {
            ...
            infoPanelTransformSpring.AddVelocityToScaleSpring(Vector3.one * -infoPanelScalePunch);
        }
