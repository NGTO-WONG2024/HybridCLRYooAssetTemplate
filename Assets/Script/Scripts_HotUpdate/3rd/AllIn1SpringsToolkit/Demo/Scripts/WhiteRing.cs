...
namespace AllIn1SpringsToolkit.Demo.Scripts
{
    public class WhiteRing : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            transformSpring.SetValuesScaleSpring(Vector3.zero);
            transformSpring.SetScaleTarget(iniScale);
        ...
        private void Update()
        {
            float scaleVelocityMagnitude = transformSpring.scaleSpring.GetVelocity().magnitude;
