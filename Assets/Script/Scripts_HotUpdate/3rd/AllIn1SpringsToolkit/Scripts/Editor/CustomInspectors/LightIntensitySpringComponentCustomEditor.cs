...
namespace AllIn1SpringsToolkit
{
	...
	public class LightIntensitySpringComponentCustomEditor : SpringComponentCustomEditor
	{
		...
		{
			DrawInitialValuesBySpring("Initial Value", LABEL_WIDTH, lightIntensitySpringDrawer);
		}

		protected override void DrawCustomInitialTarget()
		{
			DrawCustomTargetBySpring("Target", LABEL_WIDTH, lightIntensitySpringDrawer);
		}

		protected override void DrawMainAreaUnfolded()
		{
			DrawSerializedProperty(spAutoUpdatedLight, LABEL_WIDTH);
		}
